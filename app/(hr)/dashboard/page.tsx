...
import { SkeletonDashboard } from '@/components/hr/ui/Skeleton'
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                {data!.vacaciones_mes.map((v, i) => (
                  <button
                    ...
                    onClick={() => v.agente_id ? router.push(`/nomina/agente/${v.agente_id}`) : undefined}
            ...
            <div className="card p-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                {data!.licencias_hoy.map((a) => (
                  <button
                    key={a.agente_id}
                    onClick={() => router.push(`/nomina/agente/${a.agente_id}`)}
