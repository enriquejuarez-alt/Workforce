...
export default function PpayAnalisisPage() {
  const { resultado, agentes } = useResultadosPpay();
    ...
    <div className="px-6 py-6 max-w-7xl mx-auto">
      <motion.div {...fade} className="space-y-8">
        ...
        <div className="border-b border-gray-100 pb-5">
          <h2 className="text-xl font-bold text-gray-900 mb-0.5">Personal Pay — Análisis</h2>
