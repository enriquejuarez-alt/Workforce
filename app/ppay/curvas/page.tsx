...
export default function PpayCurvasPage() {
  const { resultado, matrices, agentes } = useResultadosPpay();
  ...
  return (
    <div className="px-6 py-6 max-w-7xl mx-auto">
      ...
      >
        <div className="mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-0.5">Personal Pay — Curvas</h2>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-5">
                      ...
                      <p className="text-xs text-gray-400 mb-4">
                        Disponibles considera contratos y reductores por día. Sin francos (Personal Pay).
                      </p>
                      <CurvaTemporalChart
                        matriz={matriz}
