...
export function FilterBarPpay() {
  const { agentes, activeFilters, setFilter, clearFilters } = useResultadosPpay();
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
      <div className="mb-3 flex items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[11px] text-gray-400">Ajustá la vista por servicio y condiciones de nómina</p>
          </div>
        </div>
      ...
      <div className="flex flex-wrap items-end gap-3">
        {hayIslas && (
          <FiltroSelect label="Servicio" campo="isla" opciones={opciones.islas} valor={activeFilters.isla ?? ""} onChange={setFilter} />
        )}
        {haySitios && (
