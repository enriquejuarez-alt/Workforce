            ...
            return (
              <React.Fragment key={r.servicio}>
                <tr className={cn(
                  ...
                  <td className="px-4 py-3 font-medium text-gray-800 whitespace-nowrap">{obtenerNombreNomina(r.servicio, r.servicio)}</td>
                  ...
                  <td className="px-4 py-3 tabular-nums text-gray-500" title="Reductor de entrada (deslogueo+ausentismo+rotacion) antes del motor dia a dia">
                    -{pctReductorInput}%
                  </td>
