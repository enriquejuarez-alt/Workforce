  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        {/* Info banner */}
        <div className="flex items-start gap-3 p-4 bg-konecta-pale rounded-2xl border border-konecta/20">
          <Shield size={15} className="text-konecta shrink-0 mt-0.5" />
          <div className="text-sm text-konecta-dark">
                    ...
                    <th key={rol} className="bg-gray-900 text-white px-4 py-4 text-center border-r border-gray-700 last:border-r-0" style={{ minWidth: 120 }}>
                      <div className="flex flex-col items-center gap-2">
                        ...
                        <button
                          ...
                          title={`Activar/desactivar todo para ${label}`}
                        >
                      ...
                      <td className="px-4 py-3.5 text-center border-r border-gray-100">
                        <button
                          ...
                          className={`w-8 h-8 rounded-xl flex items-center justify-center mx-auto transition-all border ${
                            allOn
                              ? 'bg-konecta border-konecta text-white shadow-sm'
                              : someOn
                                ? 'bg-konecta/10 border-konecta/30 text-konecta/60'
                                : 'bg-gray-50 border-gray-200 text-gray-300 hover:border-gray-300'
                          }`}
                          title={allOn ? 'Quitar de todos los roles' : 'Agregar a todos los roles'}
                        >
                          <CheckCircle size={14} />
                        </button>
                      </td>
