      ...
      <motion.div {...fade} className="space-y-5">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            {/* Nómina — puede ser del sistema o Excel */}
            <div className="space-y-2">
              {agentesDesdeApi ? (
                ...
                <div className="rounded-xl border-2 border-blue-100 bg-blue-50/40 p-4 space-y-3">
                  <div className="flex items-center gap-2">
                    <div className="w-5 h-5 rounded-full bg-blue-100 text-blue-600 text-[11px] font-bold flex items-center justify-center shrink-0">3</div>
                    <p className="text-sm font-semibold text-gray-800">Nómina activa</p>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full text-xs font-semibold bg-blue-600 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-lg py-1.5 flex items-center justify-center gap-1.5 transition-colors"
                  >
                    {cargandoNomina ? (
