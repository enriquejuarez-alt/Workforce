...
export const SERVICIOS: ServiceDefinition[] = [
  ...
  },
  {
    key: "SMB Tec In",
    label: "SMB Tec In",
    hojaCP: ["SMB Tec In", "SMB_Tec_In"],
    segmentosNomina: ["TECNICA", "SMB TECNICA", "SMB TEC IN"],
    reductorNombres: ["Tecnica", "TECNICA", "SMB TECNICA"],
  },
  {
    key: "SMB Digital",
    label: "SMB Digital",
    hojaCP: ["SMB_Digital", "SMB Digital"],
    segmentosNomina: ["TECNICA RRSS", "SMB TECNICA RRSS", "SMB DIGITAL"],
    reductorNombres: ["Tecnica RRSS", "TECNICA RRSS", "SMB TECNICA RRSS"],
  },
  {
    key: "SMB PTF",
    label: "SMB PTF",
    hojaCP: ["SMB PTF", "SMB_PTF"],
    segmentosNomina: ["PWTF TECNICA", "SMB PTF", "TECNICA POWER TO FRONT"],
